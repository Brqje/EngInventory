...
20190314 - Baroque edit
		   ...
		   Changed default settings: scale to from 0.64 to 1 and default columns from 9 to 10
...
function EngInventory_SetDefaultValues(re)
	...
	EI_SetDefault("putinslot--EMPTY_PROJECTILE_SLOTS", 14, 1+re, EngInventory_NumericRange, 1, ENGINVENTORY_MAX_BARS);
	EI_SetDefault("putinslot--USED_PROJECTILE_SLOTS", 14, 1+re, EngInventory_NumericRange, 1, ENGINVENTORY_MAX_BARS);
